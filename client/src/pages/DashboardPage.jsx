...
// Extracted to client/src/constants/sections.js (IDEA-39) so the canonical
// section order/metadata can also drive the prev/next "journey" navigation
// footer on each section page, not just this dashboard.
// ---------------------------------------------------------------------------
